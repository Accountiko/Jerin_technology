                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img
                          src="assets/img/clients/accountiko-home.webp"
                          alt=""
                        />
                      </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img
                          src="assets/img/clients/atb-client-home.webp"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img
                          src="assets/img/clients/dashboard-home.webp"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img
                          src="assets/img/clients/biznes-home.webp"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img
                          src="assets/img/clients/saadan-home.webp"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
