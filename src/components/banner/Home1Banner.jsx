            ...
            <div className="col-lg-6 d-flex align-items-xxl-start align-items-center">
              <div className="banner-content">
                <span>
                  ...
                  Expertise with Jerintechnology
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={14}
                    height={14}
                ...
                <p>
                oin us as we forge a successful journey, led by passion, energized by innovation, and strengthened by our team's shared spirit. We believe in the impact of bold ideas, and we're committed to making them a reality.{" "}
                </p>
                ...
                <Swiper {...settings} className="swiper banner-img-slider">
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/homebanner2.webp" alt="one" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/homebanner.webp" alt="" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/homebanner.webp" alt="" />
                    </SwiperSlide>
