          ...
          <div className="row justify-content-center mb-70">
            <div className="col-lg-8">
              ...
              >
                ...
                <p>
                  Welcome to Jerin Technology, where digital innovation meets strategic
                  ...
                  >
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingTwo">
                        ...
                        >
                          02. Is Jerin Technology suitable for my business?
                        </button>
                      </h2>
                      <div
                        id="faqcollapseTwo"
                      ...
                      >
                        <div className="accordion-body">
                          Certainly, The Jerin Technology's suitability for your business
