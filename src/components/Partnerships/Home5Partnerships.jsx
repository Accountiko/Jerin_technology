              ...
              <div className="single-pertner">
                ...
                <div className="partner-logos">
                  ...
                  style={{width:"150px",height:'auto'}}
                    className="white"
                    src="assets/img/homepage/accountiko uae logo.png"
                    alt=""
                  />
                  <img
                  style={{width:"150px",height:'auto'}}
              ...
              <div className="single-pertner">
                ...
                <div className="partner-logos">
                  <img
                   style={{width:"150px",height:'auto'}}
                    className="white"
                    src="assets/img/homepage/ATB logo small.png"
                    alt=""
                  />
                  <img
                   style={{width:"150px",height:'auto'}}
            ...
            >
              <div className="single-pertner">
                ...
                <div className="partner-logos">
                  ...
                  style={{width:"150px",height:'auto'}}
                    className="white"
                    src="assets/img/homepage/shohra logo.png"
                    alt=""
                  />
                  <img
                  style={{width:"150px",height:'auto'}}
                ...
                <p>Shohra Personal Branding Agency</p>
              </div>
            </div>
            <div
              className="col-lg-3 col-sm-6 wow animate fadeInDown"
                ...
                <div className="partner-logos">
                  <img
                   style={{width:"110px",height:'auto'}}
                    className="white"
                    src="assets/img/homepage/saadan logo small.png"
                    alt=""
                  />
                  <img
                   style={{width:"110px",height:'auto'}}
              ...
              <div className="single-pertner">
                ...
                <div className="partner-logos">
                  <img
                   style={{width:"110px",height:'auto'}}
                    className="white"
                    src="assets/img/homepage/ploxygen small.png"
                    alt=""
                  />
                  <img
                   style={{width:"110px",height:'auto'}}
            ...
            >
              <div className="single-pertner">
                ...
                <div className="partner-logos">
                  <img
                    className="white"
                    src="assets/img/homepage/bizneslogo.png"
                    alt=""
                  />
                  <img
              ...
              <div className="single-pertner">
                ...
                <div className="partner-logos">
                  <img
                   style={{width:"110px",height:'auto'}}
                    className="white"
                    src="assets/img/homepage/alogo.png"
                    alt=""
                  />
                  <img
                  style={{width:"110px",height:'auto'}}
