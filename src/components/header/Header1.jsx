                ...
                <ul className="main-menu">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <li>
                        <Link href="/service/erp-software">
                        ERP Software
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={10}
                      ...
                      <li>
                        <Link href="/service/brand marketing">
                        Brand Marketing
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={10}
                  ...
                  <ul>
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <span>Phone</span>
                        <h6>
                          <a href="tel:+91 70105 28534">+91 70105 28534</a>
                        </h6>
                      </div>
                    </li>
                    <li className="single-contact">
                      ...
                      <div className="contact">
                        <span>Email Now</span>
                        <h6>
                          <a href="mailto:mail@jerintechnology.com">mail@jerintechnology.com</a>
                        </h6>
                      </div>
                    </li>
                    <li className="single-contact">
                      ...
                      <span>Address</span>
                        <h6>
                          No. 7, Kulakarai street, Chrompet, Chennai - 44.
                        </h6>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="right-sidebar-and-hotline-area">
              <div className="hotline-area d-xl-flex d-none">
                ...
                <div className="content">
                  ...
                  <h6>
                    <Link href="tel:+990737621432">+91 70105 28534</Link>
                  </h6>
                </div>
              </div>
