                ...
                <div className="home4-footer-wrap">
                    ...
                    <div className="row g-lg-4 gy-5 justify-content-center">
                      <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="footer-widget">
                          ...
                          <h2>
                            <a href="mailto:mail@jerintechnology.com">
                              mail@jerintechnology.com
                            </a>
                          </h2>
                          {/* <div class="content">
                                          <p>Welcome to Jerin Technology, where innovation meets our passion in a journey that started with a simple idea and a shared dream.</p>
                                      </div> */}
                          ...
                          <div className="footer-author-area">
                            ...
                            <div className="author-content">
                              <div className="author-name-desig">
                                ...
                                <span>Founder / Jerin Technology</span>
                              </div>
                              <p>
                  ...
                  <div className="footer-bottom">
                    <div className="copyright-area">
                      <p>
                        Copyright 2024 <a href="#">Jerin Technology</a> 
                      </p>
                    </div>
