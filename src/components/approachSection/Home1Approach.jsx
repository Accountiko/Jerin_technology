          ...
          <div className="row mb-60">
            ...
            >
              <div className="section-title">
                ...
                <h2>The Jerin Technology Approach</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container-fluid">
            <div className="row g-xl-4 gy-5 divider">
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img src="assets/img/homepage/approach-1.webp" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img src="assets/img/homepage/approach-2.webp" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img src="assets/img/homepage/approach-3.webp" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img src="assets/img/homepage/approach-4.webp" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
