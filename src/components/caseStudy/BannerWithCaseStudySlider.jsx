        ...
        <div className="row g-0">
          <div className="col-xl-4 col-lg-5">
            <div className="banner-area">
              <img src="assets/img/homepage/home-blog.webp" alt="" />
              <div className="banner-content">
                ...
                >
                  <p>
                    ...
                    exemplifies the impact of Jerin Technology solutions.
                  </p>
                  <Link
                    href="/case-study"
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="assets/img/homepage/Home-blog-1.webp"
                          alt=""
                        />
                      </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="assets/img/homepage/home-blog-2.webp"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                        <Link href="#">It Agency</Link>
                        <h4>
                          <Link href="#">
