                ...
                <div className="error-page pt-5 pb-1">
                    <div className="container">
                        <div className="">
                            ...
                            <p>Welcome to Jerin Technology! We are committed to providing high-quality support for all our services, including website development, ERP software solutions, and digital marketing in India. Our support policy is designed to ensure that your experience with us is smooth and hassle-free.</p>
                            ...
                            <h2>2. Contacting Support</h2>
                            <p>You can reach our support team via the following channels:</p>

                            <p>Email: <a href="mailto:mail@jerintechnology.com">support@jerintechnology.com</a></p>
                            <p>Phone: +91 70105 28534</p>



                            <h2>3. Response Times</h2>
                            <p>We strive to respond to all support queries as quickly as possible. Our standard response times are as follows:</p>

                            <p>Critical issues (e.g., service outage): Within 1 hour</p>
                            <p>High priority issues (e.g., major functionality not working): Within 4 hours</p>
                            <p>Medium priority issues (e.g., minor functionality issues): Within 1 business day</p>
                            <p>Low priority issues (e.g., general inquiries): Within 2 business days</p>


                            <h2>4. Support Scope</h2>
                            <h4>Our support services cover the following:</h4>

                            <p>Troubleshooting and resolving issues related to website development, ERP software, and digital marketing services provided by Jerin Technology.</p>
                            <p>Guidance on using our products and services effectively.</p>
                            <p>Assistance with configuration and setup of our software solutions.</p>

                            <h4>Support does not include:</h4>

                            <p>Third-party software or hardware issues not related to our services.</p>
                            <p>Custom development or modifications not included in the original scope of work.</p>
                            <p>Training or education on unrelated topics.</p>


                            <h2>5. Escalation Procedure</h2>
                            <p>If your issue is not resolved to your satisfaction, you can escalate the matter by contacting our support manager at <a href="mailto:mail@jerintechnology.com">mail@jerintechnology.com</a>. We will review your case and provide a resolution within 2 business days.</p>

                            <h2>6. Service Level Agreement (SLA)</h2>
                            <p>Our SLAs are defined based on the nature and criticality of the issue.</p>

                            <h2>7. Updates to this Policy</h2>
                            <p>We may update this support policy from time to time. Any changes will be posted on this page, and we encourage you to review our policy periodically.</p>
