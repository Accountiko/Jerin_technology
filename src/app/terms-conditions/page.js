    ...
    return (
        <>
            <MainLayout>
                ...
                <div className="error-page pt-5 pb-1">
                    <div className="container">
                        <div className="">
                        <h1>Terms and Conditions</h1>

<p>Welcome to Jerin Technology! These terms and conditions outline the rules and regulations for the use of our website, services, and software solutions.</p>

<h2>1. Acceptance of Terms</h2>
<p>By accessing and using our website and services, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please do not use our services.</p>

<h2>2. Services Offered</h2>
<p>Jerin Technology provides website development, ERP software solutions, and digital marketing services in India. All services are subject to the terms and conditions outlined here.</p>

<h2>3. User Responsibilities</h2>
<h4>As a user of our services, you agree to:</h4>
<ol>
    <li>Provide accurate and up-to-date information when registering or using our services.</li>
    <li>Use our services only for lawful purposes and in compliance with all applicable laws and regulations.</li>
    <li>Not engage in any activity that could harm, disrupt, or interfere with the functioning of our services.</li>
    <li>Maintain the confidentiality of your account credentials and notify us immediately of any unauthorized access or use.</li>
</ol>

<h2>4. Payment and Billing</h2>
<p>All payments for our services are due as per the agreed terms. In case of late payment, Jerin Technology reserves the right to suspend or terminate the services until full payment is received.</p>

<h2>5. Intellectual Property</h2>
<p>All content, including but not limited to text, graphics, logos, and software, is the property of Jerin Technology and is protected by applicable intellectual property laws. You may not use, reproduce, or distribute any content from our website without our prior written consent.</p>

<h2>6. Termination of Services</h2>
<p>Jerin Technology reserves the right to terminate or suspend your access to our services at any time, without notice, for conduct that we believe violates these terms, is harmful to our interests, or for any other reason at our discretion.</p>

<h2>7. Limitation of Liability</h2>
<p>Jerin Technology will not be liable for any direct, indirect, incidental, consequential, or punitive damages arising out of your use or inability to use our services. Our total liability for any claims arising from our services will not exceed the amount paid by you for the services in question.</p>
...
<p>We may update these terms and conditions from time to time. Any changes will be posted on this page, and your continued use of our services constitutes your acceptance of the revised terms.</p>

<h2>10. Contact Information</h2>
<p>If you have any questions or concerns about these terms and conditions, please contact us at <a href="mailto:mail@jerintechnology.com">mail@jerintechnology.com</a>.</p>

                            <div style={{ width: 200, margin: 'auto' }} className="star-btn ">
                                <Link href="/">
                                    <div className="bg">
                                        <svg
