...
import {convertTitleToSlug} from '../page'



const BlogDetails = ({params:{slug}}) => {

  const [blogDetails,setBlogdetails] = useState({})

  const getEachBlog = async()=>{
 
    const blogDocRef = doc(db, 'blogs', slug[1]);
    const blogDocSnap = await getDoc(blogDocRef);
    console.log(blogDocSnap.data())
    setBlogdetails(blogDocSnap.data())
  }
            ...
            <div className="col-12">
              ...
              <div className="blog-details-author-meta">
                ...
                <ul>
                  ...
                  { timestamptodate(blogDetails.date)}
                  </li>
                  <li>
                    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
