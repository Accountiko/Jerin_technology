            ...
            >
              <div className="about-content">
                <div className="about-section-title">
                  ...
                  <h2>
                  At Jerin Technology, we embrace the ever-changing digital
                    landscape and take care of the groundwork.
                  </h2>
                  <p>
                  Where innovation meets passion, our journey began with a
                    simple idea and a shared dream. Founded recently, we
                    embarked on a mission to bring new innovations and introduce
                    cutting-edge technology. From humble beginnings to our
                    current ambitions, every step has been driven by relentless
                    commitment
                  </p>
                </div>
              </div>
